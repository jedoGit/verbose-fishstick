...
This project is a REST-API client and server. The front-end is a borrowed project `(author is Maximillian)` and is written in `ReactJs`. The back-end is a `NodeJs` project using the `ExpressJs` framework.
...
> window.REACT_APP_BACKEND_SERVER_ADDR = "http://localhost:30443";
> ```
>
...
> 3. REST-API-Server-Nginx-Reverse-Proxy/dockerbuild.sh
> ```
>
...
> 3. REST-API-Server-Nginx-Reverse-Proxy/kubernetes/service-nginx.yaml
> 4. Database/kubernetes/service-mongo.yaml
> ```
>
...
> 4. REST-API-Server-Nginx-Reverse-Proxy/kubernetes/deployment-nginx.yaml
> ```
>
...
> 3. REST-API-Server-Nginx-Reverse-Proxy/kubernetes/hpa-nginx.yaml
> 4. Database/kubernetes/hpa-db.yaml
> ```
>
> - Access the frontend client `https:\\localhost:31443` or `http://<minikubeIP>:31443`
